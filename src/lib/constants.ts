...
export const DAO_SERVICE = APIdomain
export const PUBLIC_BSKY_SERVICE = `${APIdomain}/bsky` // 'https://xiangjiandao.rivtower.cc/bsky'
...
// 服务条款
export const SERVICE_PROTOCOL_FILE_URL = `${window.location.origin}/doc/乡建DAO-用户服务协议.pdf`
// 隐私政策
export const PRIVACY_PROTOCOL_FILE_URL = `${window.location.origin}/doc/乡建DAO-隐私政策.pdf`
// 官方联系邮箱
export const CONTACT_EMAIL = 'xjdaos@126.com'
